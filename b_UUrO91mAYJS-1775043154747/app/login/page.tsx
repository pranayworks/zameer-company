      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center relative bg-[#fdf9f2]">
        <div className="w-full max-w-[440px] px-8 py-12 flex flex-col">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-4 bg-white border border-[#e2dfd9] py-4 text-[10px] uppercase tracking-[0.2em] font-bold text-[#1c1c18] hover:bg-[#1c1c18]/5 transition-all mb-8 shadow-sm group"
          >
