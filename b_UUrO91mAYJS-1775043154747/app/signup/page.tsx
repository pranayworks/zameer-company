        ...
        <div className="w-full max-w-[440px] px-8 py-12 flex flex-col">
          ...
          <div className="mb-10 flex flex-col gap-3">
            ...
            <button 
              type="button" 
              onClick={() => {
                document.getElementById('emailSignUpForm')?.scrollIntoView({ behavior: 'smooth' });
                document.getElementById('fullName')?.focus();
              }}
              className="w-full flex items-center justify-center gap-3 border border-[#e2dfd9] py-4 text-[10px] uppercase tracking-[0.2em] font-bold text-[#1c1c18] hover:bg-[#1c1c18]/5 transition-all shadow-sm"
            >
          ...
          <div className="relative w-full flex items-center justify-center mb-8 overflow-hidden">
            <div className="absolute w-full h-[1px] bg-[#e2dfd9]" />
            <span className="relative bg-[#fdf9f2] px-4 text-[9px] uppercase tracking-[0.3em] text-[#a09e96]">Or join via form</span>
          </div>

          <form id="emailSignUpForm" className="space-y-6 flex flex-col">
