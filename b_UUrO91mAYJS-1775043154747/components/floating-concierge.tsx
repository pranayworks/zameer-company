        ...
        {isVisible && (
          <>
            ...
            <motion.button
              ...
              exit={{ opacity: 0, y: 20 }}
              onClick={scrollToTop}
              className="w-12 h-12 bg-white border border-[#1c1c18]/10 text-[#1c1c18] shadow-2xl flex items-center justify-center hover:bg-[#1c1c18] hover:text-white transition-all pointer-events-auto group"
            ...
            <motion.a
              ...
              className="bg-[#25D366] text-white w-12 h-12 flex items-center justify-center shadow-2xl hover:scale-110 transition-transform pointer-events-auto"
              aria-label="Connect with Atelier"
            >
