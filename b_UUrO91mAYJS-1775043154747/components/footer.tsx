              ...
              {socialLinks.map((social) => (
                ...
                >
                  {social.label === 'Instagram' ? (
                    <svg className="w-6 h-6 fill-current group-hover:text-[#E4405F] transition-colors" viewBox="0 0 24 24">
                    ...
                    <svg className="w-6 h-6 fill-current group-hover:text-[#25D366] transition-colors" viewBox="0 0 24 24">
