    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
           ...
           animate={{ opacity: 1 }}
           exit={{ opacity: 0 }}
           className="fixed inset-0 z-[110] bg-[#fdf9f2] flex flex-col"
        >
          {/* Header */}
          ...
          {/* Search Body */}
          <div className="flex-1 flex flex-col items-center justify-center px-12 pb-24 relative">
            <motion.div 
            ...
            >
              <input 
                 ...
                 placeholder="Search Friends of 4..."
                 className="w-full bg-transparent border-b-2 border-[#1c1c18] pb-8 text-5xl md:text-8xl font-headline outline-none placeholder:opacity-10 focus:border-[#a3851a] transition-all"
              />
